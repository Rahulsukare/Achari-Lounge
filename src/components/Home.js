...
const Home = () => {
    ...
    return (
        <>
            ...
            <About />
            <Reviews />
            <div className='bg-gradient-to-r from-green-700 to-green-600 w-full md:w-3/4 mx-auto my-10 rounded-xl p-12 z-50 relative animate-fade-in'>
                <img src={deliveryBoy} alt="deliveryBoy" className='hidden md:block md:w-fit  absolute bottom-0 right-0' />
